...
export const labels: Record<string,string> = {available:'Tersedia',renting:'Disewa',maintenance:'Perawatan',in_transit:'Dalam Mobilisasi',active:'Aktif',draft:'Draf',final:'Final',completed:'Selesai',pending:'Menunggu Persetujuan',approved:'Disetujui',rejected:'Ditolak',unpaid:'Belum Dibayar',partial:'Dibayar Sebagian',paid:'Lunas',overdue:'Jatuh Tempo',mobilization:'Mobilisasi',demobilization:'Demobilisasi',admin:'Administrator',operations:'Manajer Operasional',operator:'Operator',finance:'Staf Keuangan',transfer:'Transfer Bank',cash:'Tunai',giro:'Giro / Cek',other:'Lainnya',banned:'Nonaktif',WIB:'WIB (Jakarta)',WITA:'WITA (Makassar)',WIT:'WIT (Jayapura)'};
