...
const fullDayFormatter = new Intl.DateTimeFormat('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric', timeZone: 'Asia/Jakarta' });
...
// zona Asia/Jakarta (UTC+7) sehingga tanggal kalendernya tetap sama — aman.
export const fullDateLabel = (value: string | Date) => fullDayFormatter.format(new Date(value));
