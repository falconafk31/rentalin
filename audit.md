...
| O11 | **✅ DM-5 ditutup — night mode dibatasi ke halaman login** | `src/app/globals.css`, `src/components/login-form.tsx` | Keputusan produk 14 Sep 2026: dashboard/ruang kerja tetap terang agar permukaan kerja data konsisten; tidak ada lagi selector global `[data-theme="dark"]`. Login memakai palet malam terisolasi. | ✅ Selesai |
| O12 | **✅ DM-6 tidak berlaku** | `src/components/overview.tsx` | Chart hanya berada di ruang kerja yang selalu terang, sehingga tidak membutuhkan varian warna dark mode yang berbeda. | ✅ N/A berdasarkan keputusan produk |
| O13 | **✅ DM-7 ditutup** | `src/app/layout.tsx` | Tidak ada lagi tema global yang mengikuti preferensi OS/localStorage. Halaman verifikasi publik dan pemulihan akses tetap terang; hanya `/login` yang memakai night mode. | ✅ Selesai |
